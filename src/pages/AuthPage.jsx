...
export default function AuthPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // The signup() function is NOT called.
    toast.error("Can't create account now");
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div
          className="absolute w-[500px] h-[500px] rounded-full opacity-[0.08] blur-3xl"
          style={{
        ...
        <div
          className="absolute w-[400px] h-[400px] rounded-full opacity-[0.06] blur-3xl"
          style={{
        ...
        <div
          className="absolute w-[300px] h-[300px] rounded-full opacity-[0.04] blur-3xl"
          style={{
